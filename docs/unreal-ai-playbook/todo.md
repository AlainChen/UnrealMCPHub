...
- [x] define a baseline brief for `Gym-05` `3D Animation / Locomotion`
- [x] record the first `Gym-05` baseline boundary finding so the track does not imply locomotion is already validated
